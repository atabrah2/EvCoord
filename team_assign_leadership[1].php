...
$sql = "UPDATE Team SET leader_id='$user_id' WHERE name='$team_name' AND event_name='$event_name' AND event_start='$event_start' AND event_end='$event_end'";
$res = mysql_query($sql);
if (!$res) {
    print ("Attempt to change leadership failed");
}
else {
    print("You have successfully assigned leadership of $team_name to $user_id");
}
mysql_close();
?>
</div>
