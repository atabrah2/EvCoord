...
<div class="container">
    ...
    print("<form action=\"team_edit_submit.php?team_name=$team_name&event_name=$event_name&event_start=$event_start&event_end=$event_end\" method=\"post\" target=\"_top\">");
    ?>
        <?php
            print("<h1 class=\"page-header\">Editing: $team_name</h1>");
            print("<h3 class=\"sub-header\">Participating in: ($status_str[$status]) $event_name [$event_start]-[$event_end]</h3>");
        ?>
        <label style=color:black><b>Team Name</b></label>
        <?php
        print("<input type=\"text\" class=\"input1\" value=\"$team_name\" name=\"name\" required>");
        ?>
        <label style=color:black><b>Team Description</b></label>
        <?php
        print("<input type=\"text\" class=\"input1\" value=\"$team_desc\" name=\"description\" required>");
        ?>
        <br/>
