...
//get description and role from database. didn't put them in GET because description could be long.
...
$skill_name = $data['skill_requested'];
$skill_desc = $data['skill_desc'];


//also prevent user from accepting when they're already in a team for that event
$sql = "SELECT * FROM Member WHERE event_name = '$event_name' AND event_start = '$event_start' AND event_end = '$event_end'";
$res = mysql_query($sql);
